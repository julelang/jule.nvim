...
" core keywords
syntax keyword juleKeyword chan error throw use fn struct enum unsafe let match defer if else for in
syntax keyword juleKeyword impl trait break continue goto extern type return fall co select async await

" type keywords
syntax keyword juleType int uint uintptr i8 i16 i32 i64 u8 u16 u32 u64 f32 f64 cmplx64 cmplx128 bool string any byte rune map
